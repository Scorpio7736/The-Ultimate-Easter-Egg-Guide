...
public class DerEisendrache_EasterEggs
{
    ...
    public static final EasterEgg RagnarokDG4 =
            new EasterEgg("Ragnarok DG-4")

                    .addStep(new EasterEggStep("Collect the Panzer Soldat Part")
                            .addSubStep(new EasterEggStep(
                    ...
                    .addStep(new EasterEggStep("Collect the Death Ray Part")
                            .addSubStep(new EasterEggStep(
                    ...
                    .addStep(new EasterEggStep("Collect the Rocket Test Part and Build the Ragnarok")
                            .addSubStep(new EasterEggStep(
    ...
    public static final EasterEgg RocketShield =
            new EasterEgg("Rocket Shield")
                    ...
                    .addStep(new EasterEggStep("Collect the Rocket Canisters")
                            .addSubStep(new EasterEggStep(
                    ...
                    .addStep(new EasterEggStep("Collect the Griffin Plate")
                            .addSubStep(new EasterEggStep(
                    ...
                    .addStep(new EasterEggStep("Collect the Shield Frame and Build the Shield")
                            .addSubStep(new EasterEggStep(
    ...
    public static final EasterEgg WrathOfTheAncients =
            new EasterEgg("Wrath of the Ancients")

                    .addStep(new EasterEggStep("Feed the Courtyard Dragon")
                            .addSubStep(new EasterEggStep(
                    ...
                    .addStep(new EasterEggStep("Feed the Church Dragon")
                            .addSubStep(new EasterEggStep(
                    ...
                    .addStep(new EasterEggStep("Feed the Pyramid Dragon")
                            .addSubStep(new EasterEggStep(
                    ...
                    .addStep(new EasterEggStep("Collect the Wrath of the Ancients")
                            .addSubStep(new EasterEggStep(
    ...
    public static final EasterEgg StormBow =
            new EasterEgg("Storm Bow")

                    .addStep(new EasterEggStep("Begin the Storm Bow Quest")
                            .addSubStep(new EasterEggStep(
                    ...
                    .addStep(new EasterEggStep("Ignite the Three Bonfires")
                            .addSubStep(new EasterEggStep(
                    ...
                    .addStep(new EasterEggStep("Activate the Wall-Run Symbols")
                            .addSubStep(new EasterEggStep(
                    ...
                    .addStep(new EasterEggStep("Charge the Three Electrical Urns")
                            .addSubStep(new EasterEggStep(
                    ...
                    .addStep(new EasterEggStep("Electrify the Bonfires")
                            .addSubStep(new EasterEggStep(
                    ...
                    .addStep(new EasterEggStep("Charge and Collect the Storm Bow")
                            .addSubStep(new EasterEggStep(
    ...
    public static final EasterEgg WolfBow =
            new EasterEgg("Wolf Bow")

                    .addStep(new EasterEggStep("Activate the Four Wolf Paintings")
                            .addSubStep(new EasterEggStep(
                    ...
                    .addStep(new EasterEggStep("Retrieve the Wolf Skull")
                            .addSubStep(new EasterEggStep(
                    ...
                    .addStep(new EasterEggStep("Follow the Spectral Wolf")
                            .addSubStep(new EasterEggStep(
                    ...
                    .addStep(new EasterEggStep("Retrieve, Charge, and Collect the Wolf Bow")
                            .addSubStep(new EasterEggStep(
    ...
    public static final EasterEgg VoidBow =
            new EasterEgg("Void Bow")

                    .addStep(new EasterEggStep("Begin the Void Bow Quest")
                            .addSubStep(new EasterEggStep(
                            ...
                            .addSubStep(new EasterEggStep("Melee-kill a zombie while it is standing on the glowing purple floor tile.").addImage())
                            .addSubStep(new EasterEggStep(
                                    "Interact with the broken tile to release the floating urn."
                            ))
                    )

                    .addStep(new EasterEggStep("Collect the Six Skulls and Feed the Urn")
                            .addSubStep(new EasterEggStep(
                    ...
                    .addStep(new EasterEggStep("Collect the Purple Runes")
                            .addSubStep(new EasterEggStep(
                    ...
                    .addStep(new EasterEggStep("Decode the Knights and Retrieve the Arrow")
                            .addSubStep(new EasterEggStep(
                    ...
                    .addStep(new EasterEggStep("Charge and Collect the Void Bow")
                            .addSubStep(new EasterEggStep(
    ...
    public static final EasterEgg FireBow =
            new EasterEgg("Fire Bow")

                    .addStep(new EasterEggStep("Begin the Fire Bow Quest")
                            .addSubStep(new EasterEggStep(
                    ...
                    .addStep(new EasterEggStep("Activate and Charge the Three Fire Circles")
                            .addSubStep(new EasterEggStep(
                    ...
                    .addStep(new EasterEggStep("Move the Fire Rock into the Fireplace")
                            .addSubStep(new EasterEggStep(
                    ...
                    .addStep(new EasterEggStep("Reforge, Charge, and Collect the Fire Bow")
                            .addSubStep(new EasterEggStep(
    ...
    public static final List<Procedure> DerEisendrache_Buildables = Arrays.asList(
        RagnarokDG4,
        RocketShield,
        WrathOfTheAncients,
        StormBow,
