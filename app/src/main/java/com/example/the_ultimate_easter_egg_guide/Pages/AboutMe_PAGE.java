...
public class AboutMe_PAGE extends PageController_BaseClass {
    ...
    private void setupContent() {
        ...
        if (contact != null) {
            contact.setText("• Jack London / Scorpio7736\n• GitHub: https://github.com/Scorpio7736\n• Jack@thelondons.com");
        }

        if (team != null) {
            team.setText("• Jack London – Project Creator & Developer");
        }
        ...
        if (audioCredits != null) {
            audioCredits.setText("Special thanks to the musicians and production teams who contributed to the atmosphere of Zombies throughout the franchise.");
        }
